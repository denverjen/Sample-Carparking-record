...
if ($search_txt == "" ) {
  ...
  $query = "SELECT *,TIMESTAMPDIFF(SECOND, time_in, time_out) / 60 as time_stay ". 
           "FROM carparking where carno LIKE '".$search_txt."%' and parking = 0 order by time_in desc LIMIT 500";
  // echo $query ;
  $carparkresult = mysqli_query($conn, $query);
  $total_records = mysqli_num_rows($carparkresult);
  ...
  <body>
    ...
    <div class="container" style="width:900px;">
      ...
      <!-- Input form for search -->
        <form action="carparkhistory.php" method="GET" class="col-12 col-md-6">
        <div class="input-group mb-3">
      	  <input type="text" name="search" class="form-control" placeholder="尋找" aria-label="Username" aria-describedby="basic-addon1">
        </div>
        </form>
      </div> 
      </div>
